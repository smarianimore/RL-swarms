...
class Slime(AECEnv):
    ...
    def _lay_pheromone(self, patches, agent_pos, agent_type):
        """
    ...
    def do_action1(self):
        self.patches = self._lay_pheromone(
            self.patches, self.learners[self.agent]['pos'], self.learners[self.agent]['mode']
        )
