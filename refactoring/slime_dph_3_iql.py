...
import numpy as np
import random
from environments.slime_dph_3.slime_dph import Slime
...
def main(args):
    ...
    if args.render:
        from environments.slime_dph_3.slime_dph import SlimeVisualizer
        env_vis = SlimeVisualizer(env.W_pixels, env.H_pixels, **v_params)
    else:
        env_vis = None
    states = params['sniff_patches'] * 2
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--params_path",
        type=str,
        default="environments/slime_dph_3/config/env-params.json",
        required=False
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="environments/slime_dph_3/config/env_visualizer-params.json",
        required=False
    )
